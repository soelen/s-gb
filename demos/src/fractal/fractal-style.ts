...
import pattern from './pattern.svg?raw';

const fractalStyle = css`
...
/* Header */
	...
	#header {
		...
		background-image: url("data:image/svg+xml;charset=utf8,${ unsafeCSS( encodeURIComponent( pattern ) ) }");
