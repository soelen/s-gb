...
import intro from './intro.svg?raw';

const hyperspaceStyle = css`
...
/* Intro */
	...
	#intro {
		...
		background-image: url("data:image/svg+xml;charset=utf8,${ unsafeCSS( encodeURIComponent( intro ) ) }");
...
export default hyperspaceStyle;
